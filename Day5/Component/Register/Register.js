    ...
    <Sidebar/>
         ...
         <div className='rectangle072'>
             ...
             <form onSubmit={formHolder}>
                ...
                <input type='text' placeholder='Enter your firstname' value={firstname}  onChange={(e)=>setFirstName(e.target.value)}></input><br/>
                
                <label>LastName &nbsp;&nbsp;&nbsp;</label>
                <input type='text' placeholder='Enter your lastname' value={lastname}  onChange={(e)=>setLastName(e.target.value)}></input><br/>
               ...
               <label>Country&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
               <input type='text' placeholder='Enter your country' value={country}  onChange={(e)=>setCountry(e.target.value)}></input><br/>
