...
import Ele from './Component/Pages/Ele';
import Tiger from './Component/Pages/Tiger';
import Bio from './Component/Pages/Bio';
import InsideAnimal from './Component/Pages/InsideAnimal';
    ...
    <div className="App">
         ...
         <BrowserRouter>
          <Routes>
             ...
             <Route path='/elephant' element={<Ele/>}/>
             <Route path='/tiger' element={<Tiger/>}/>
             <Route path='/footer' element={<Footer/>}/>
             <Route path='/bio' element={<Bio/>}/>
             <Route path='/insideanimal' element={<InsideAnimal/>}/>
          </Routes>
         </BrowserRouter>
