...
export default function Home() {
  ...
  return (
    ...
    <section className='home' id="home">
         ...
         <button className='buthome'><Link to='/tamilnadu'>Explore</Link></button>
...
{/*         <div className='user1'>
    ...
    <div className="seller container">
      ...
      <div className="best-seller">
        ...
        <div className="best-p1">
          <Link to='/amazon'><img src="https://images.pexels.com/photos/931007/pexels-photo-931007.jpeg?auto=compress&cs=tinysrgb&w=600" alt="img" /></Link>&nbsp;&nbsp;
          <div className="best-p1-txt">
            <div className="name-of-p">
              <p>Amazon Rainforest located in <br/>South America</p>
            </div>
          </div>
        </div>
        
        <div className="best-p1">
          <Link to='/bio'><img src="https://i.pinimg.com/564x/e0/ca/51/e0ca5146d8d3744fc8658c7d4b5e461a.jpg" alt="img"  /></Link>&nbsp;&nbsp;
          <div className="best-p1-txt">
            <div className="name-of-p">
              <p>Bialowieza Forest located in <br/>Eastern Europe.</p>
            </div>
          </div>
        </div>
  ...
  <div className='animelcontainer'>
           ...
           <div className='intro'>
              ...
              lions are in danger in some places because their homes are disappearing. <Link to='/lion'><span>Learnmore</span></Link></p>
           </div>
           </div>
           ...
           <div className='intro'>
              ...
              It's known for its long trunk, big ears, and large body.Elephants are usually gray in color.<Link to='/elephant'><span> Learnmore</span></Link></p>
           </div>
           </div>
           ...
           <div className='intro'>
              ...
              Tigers are great hunters.<Link to='/tiger'><span> Learnmore</span></Link></p>
           </div>
           </div>
